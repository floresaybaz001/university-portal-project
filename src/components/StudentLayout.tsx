      ...
      <div className="relative -mt-16 pb-6 border-b bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center mb-4 !bg-none !bg-cover !bg-center">
            <div className="rounded-full border-4 border-background bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center shadow-xl !bg-[url(https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/35628061-b292-41c0-8ec7-066778269a72/visual-edit-uploads/1762093575702-d8wa9x8wgdd.jpeg)] !bg-cover !bg-center !w-[132px] !h-full !opacity-100 !py-0">
