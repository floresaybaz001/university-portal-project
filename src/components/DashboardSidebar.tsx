...
const menuItems = [
  ...
  { icon: FileText, label: "Student Services", href: "/services" },
  { icon: Calendar, label: "Academic Calendar", href: "/calendar" },
  { icon: CreditCard, label: "Fee Payment", href: "/payments" },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t space-y-2">
            <div className="px-3 py-2 bg-muted rounded-lg">
              ...
              <p className="text-xs text-muted-foreground">STU123456</p>
            </div>
