...
const navItems = [
  ...
  { label: "Child Profile", href: "/parent/child", icon: UserCircle },
...
export default function ParentLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-sky-50 to-blue-100 dark:from-blue-950 dark:via-sky-950 dark:to-blue-900">
      ...
      <div className="relative -mt-24 pb-6 border-b bg-background/95 backdrop-blur">
        <div className="container mx-auto px-4">
          <div className="flex justify-center mb-4">
            <div className="w-32 h-32 rounded-full border-4 border-background bg-gradient-to-br from-pink-500 to-purple-500 flex items-center justify-center shadow-xl">
          ...
          <div className="text-center space-y-1 mb-6">
            ...
            <p className="text-sm text-muted-foreground">{userData.relationship}</p>
            <p className="text-sm font-medium">Guardian of: {userData.childName}</p>
          </div>
