      ...
      <div className="relative -mt-24 pb-6 border-b bg-background/95 backdrop-blur">
        <div className="container mx-auto px-4">
          <div className="flex justify-center mb-4">
            <div className="w-32 h-32 rounded-full border-4 border-background bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center shadow-xl">
